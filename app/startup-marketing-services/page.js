  ...
  const services = [
    {
      ...
      desc: "Comprehensive marketing strategy to successfully launch your startup.",
    },
    {
      icon: IconTrendingUp,
      title: "Growth Hacking",
      desc: "Innovative tactics to accelerate user acquisition and brand growth.",
    },
    {
      icon: IconUsers,
      title: "Audience Targeting",
      desc: "Identify and engage your ideal customers across multiple channels.",
    },
    {
      icon: IconCheck,
      title: "Analytics & Optimization",
      desc: "Track performance and refine campaigns for maximum ROI.",
    },
  ];

  const process = [
    "Understand startup goals & vision",
    "Develop a launch marketing strategy",
    "Create campaigns for user acquisition",
    "Engage and grow target audience",
    "Measure results & optimize campaigns",
    "Support ongoing growth and scaling",
  ];
    ...
    <BgLayout>
      ...
      <section className="relative h-[55vh] mt-21 flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0">
          <img
            src="/services/startup-marketing-hero.webp"
        ...
        <div className="relative z-10 max-w-5xl px-6 text-center text-white">
          <div className="flex justify-center items-center gap-2 text-sm mb-6">
            ...
            <span className="text-blue-300">Startup Marketing</span>
          </div>
          ...
          >
            Startup <span className="text-blue-400">Marketing</span>
          </motion.h1>

          <p className="text-xl text-blue-100 max-w-3xl mx-auto">
            Launch, grow, and scale your startup with innovative marketing strategies tailored for early-stage companies.
          </p>
        </div>
      </section>
          ...
          <div className="lg:col-span-2 space-y-20">
            ...
            >
              <h2 className="text-4xl font-bold mb-6">
                Expert <span className="text-blue-600">Startup Marketing</span>
              </h2>

              <p className="text-gray-600 text-lg mb-4">
                Every startup needs a solid marketing plan to make a strong market entry.
              </p>

              <p className="text-gray-600 text-lg mb-4">
                We provide full-service marketing solutions that help startups reach their first users and gain traction quickly.
              </p>

              <p className="text-gray-600 text-lg">
                From campaign strategy to growth hacking, we handle everything to help your startup succeed.
              </p>
            </motion.div>
            ...
            <div className="bg-gradient-to-br from-blue-600 to-blue-800 text-white rounded-3xl p-12 text-center">
              ...
              <p className="text-blue-100 mb-8">
                Let our experts plan and execute a full-scale marketing strategy for your startup growth.
              </p>
              <Link
                href="/contact"
                className="inline-block bg-white text-blue-600 px-8 py-4 rounded-lg font-semibold"
              >
                Start Startup Marketing
              </Link>
            </div>
