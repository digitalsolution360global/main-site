  ...
  const services = [
    {
      icon: IconUserCheck,
      title: "User Research",
      desc: "Deep user research to understand behavior, needs and pain points.",
    },
    {
      icon: IconLayout,
      title: "Wireframing & Prototyping",
      desc: "Low & high-fidelity wireframes for seamless user journeys.",
    },
    {
      icon: IconDeviceMobile,
      title: "UI Design Systems",
      desc: "Consistent, scalable and visually appealing design systems.",
    },
    {
      icon: IconTrendingUp,
      title: "UX Optimization",
      desc: "Improve engagement, retention and conversion rates.",
    },
  ];

  const process = [
    "User & business requirement analysis",
    "Persona & journey mapping",
    "Wireframing & prototyping",
    "Visual UI design",
    "Usability testing & feedback",
    "Final handoff & design support",
  ];
    ...
    <BgLayout>
      ...
      <section className="relative h-[55vh] mt-21 flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0">
          <img
            src="/services/ui-ux-design-hero.webp"
        ...
        <div className="relative z-10 max-w-5xl px-6 text-center text-white">
          ...
          >
            UI / UX <span className="text-blue-400">Design Services</span>
          </motion.h1>

          <p className="text-xl text-blue-100 max-w-3xl mx-auto">
            Design intuitive, engaging and user-first digital experiences.
          </p>
        </div>
      </section>
          ...
          <div className="lg:col-span-2 space-y-20">
            ...
            >
              <h2 className="text-4xl font-bold mb-6">
                User-Centered <span className="text-blue-600">UI / UX Design</span>
              </h2>

              <p className="text-gray-600 text-lg mb-4">
                Great design is not just about looks — it’s about experience.
              </p>

              <p className="text-gray-600 text-lg mb-4">
                We create interfaces that are intuitive, accessible and conversion-focused.
              </p>

              <p className="text-gray-600 text-lg">
                Our UI/UX designs help users move smoothly from entry to action.
              </p>
            </motion.div>
            ...
            <div>
              <h2 className="text-4xl font-bold mb-10">
                Our <span className="text-blue-600">UI / UX Capabilities</span>
              </h2>
            ...
            <div className="bg-gradient-to-br from-blue-600 to-blue-800 text-white rounded-3xl p-12 text-center">
              ...
              <p className="text-blue-100 mb-8">
                Let’s design interfaces your users will love.
              </p>
              <Link
                href="/contact"
