  ...
  const services = [
    {
      ...
      desc: "Design brochures, flyers, banners, and other print materials that attract attention.",
    },
    {
      icon: IconPalette,
      title: "Digital Graphics",
      desc: "Create stunning visuals for websites, social media, and digital campaigns.",
    },
    {
      icon: IconAd,
      title: "Infographics & Visual Storytelling",
      desc: "Communicate complex ideas with engaging infographics and graphics.",
    },
    {
      icon: IconCheck,
      title: "Consistent Branding",
      desc: "Ensure all graphic design materials align with your brand identity.",
    },
  ];

  const process = [
    "Client briefing & objectives",
    ...
    <BgLayout>
      ...
      <section className="relative h-[55vh] mt-21 flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0">
          <img
            src="/services/graphic-design-hero.webp"
        ...
        <div className="relative z-10 max-w-5xl px-6 text-center text-white">
          <div className="flex justify-center items-center gap-2 text-sm mb-6">
            ...
            <span className="text-blue-300">Graphic Design</span>
          </div>
          ...
          <p className="text-xl text-blue-100 max-w-3xl mx-auto">
            Professional graphic design services to create compelling visuals for your brand and marketing.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-3 gap-12 items-start">
          ...
          <div className="lg:col-span-2 space-y-20">
            ...
            >
              <h2 className="text-4xl font-bold mb-6">
                Creative <span className="text-blue-600">Graphic Design</span>
              </h2>

              <p className="text-gray-600 text-lg mb-4">
                Graphic design is essential for creating a strong visual identity and engaging your audience effectively.
              </p>

              <p className="text-gray-600 text-lg mb-4">
                Our team delivers professional designs for digital and print platforms, ensuring every graphic aligns with your brand.
              </p>

              <p className="text-gray-600 text-lg">
                From marketing materials to digital visuals, we create designs that resonate with your target audience.
              </p>
            </motion.div>
            ...
            <div>
              <h2 className="text-4xl font-bold mb-10">
                Our <span className="text-blue-600">Graphic Design Services</span>
              </h2>
            ...
            <div className="bg-gradient-to-br from-blue-600 to-blue-800 text-white rounded-3xl p-12 text-center">
              ...
              <p className="text-blue-100 mb-8">
                Let’s craft professional graphics that enhance your marketing and brand presence.
              </p>
              <Link
                href="/contact"
                className="inline-block bg-white text-blue-600 px-8 py-4 rounded-lg font-semibold"
              >
                Get Graphic Design Consultation
              </Link>
            </div>
          ...
          <aside className="bg-white shadow-xl rounded-2xl p-6 sticky top-28">
            ...
            <ul className="space-y-3 text-gray-700">
              ...
              <li className="font-medium text-blue-600">Graphic Design</li>
