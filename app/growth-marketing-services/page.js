  ...
  const services = [
    {
      ...
      desc: "Acquire, activate, retain, and monetize customers across the entire funnel.",
    },
    {
      icon: IconTarget,
      title: "Experimentation & Testing",
      desc: "Rapid A/B testing to discover scalable growth opportunities.",
    },
    {
      icon: IconChartBar,
      title: "Data-Led Optimization",
      desc: "Growth decisions powered by insights, not assumptions.",
    },
    {
      icon: IconRocket,
      title: "Sustainable Scaling",
      desc: "Build long-term growth engines, not short-term spikes.",
    },
  ];

  const process = [
    "Growth audit & opportunity mapping",
    "Customer journey analysis",
    "Experiment design & testing",
    "Channel & funnel optimization",
    "Retention & LTV improvement",
    "Scaling winning growth loops",
  ];
    ...
    <BgLayout>
      ...
      <section className="relative h-[55vh] mt-21 flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0">
          <img
            src="/services/growth-marketing-hero.webp"
            alt="Growth Marketing Services"
        ...
        <div className="relative z-10 max-w-5xl px-6 text-center text-white">
          <div className="flex justify-center items-center gap-2 text-sm mb-6">
            ...
            <span className="text-blue-300">Growth Marketing</span>
          </div>
          ...
          >
            Growth <span className="text-blue-400">Marketing</span>
          </motion.h1>

          <p className="text-xl text-blue-100 max-w-3xl mx-auto">
            Build predictable, scalable, and sustainable growth for your business.
          </p>
        </div>
      </section>
          ...
          <div className="lg:col-span-2 space-y-20">
            ...
            >
              <h2 className="text-4xl font-bold mb-6">
                Why <span className="text-blue-600">Growth Marketing?</span>
              </h2>

              <p className="text-gray-600 text-lg mb-4">
                Growth marketing goes beyond ads — it focuses on long-term,
                compounding growth.
              </p>

              <p className="text-gray-600 text-lg mb-4">
                We experiment, analyze, and optimize every stage of the customer journey.
              </p>

              <p className="text-gray-600 text-lg">
                The result is consistent growth across acquisition, retention, and revenue.
              </p>
            </motion.div>
            ...
            <div>
              <h2 className="text-4xl font-bold mb-10">
                Our <span className="text-blue-600">Growth Capabilities</span>
              </h2>
